...
class PojoTest {
  // The package to test
  private static final String POJO_PACKAGE = "com.ets.SecurePharmacy.tenant.model";
  ...
  void testPojoStructureAndBehavior() {
    ...
    for (PojoClass pojoClass : pojoClasses) {
      ...
      if (classUnderTest.getCanonicalName().equals(AuthRequest.class.getCanonicalName())){
        continue;
      }
